...
derive the corpus from thirty-seven sources — thirty-five pinned upstreams and one written here — each fetched by URL, verified
...
- [x] Adapter pipeline: 37 sources, integrity-verified, integrity-verified, provenance per path
