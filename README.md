...
derive the corpus from thirty-four pinned upstreams — each fetched by URL, verified
...
- [x] Adapter pipeline: 34 pinned sources, integrity-verified, provenance per path
