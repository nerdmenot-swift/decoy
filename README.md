...
derive the corpus from thirty pinned upstreams — each fetched by URL, verified
...
- [x] Adapter pipeline: 30 pinned sources, integrity-verified, provenance per path
