...
derive the corpus from thirty-six sources — thirty-five pinned upstreams and one written here — each fetched by URL, verified
...
- [x] Adapter pipeline: 36 sources, integrity-verified, integrity-verified, provenance per path
