...
derive the corpus from twenty-nine pinned upstreams — each fetched by URL, verified
...
- [x] Adapter pipeline: 29 pinned sources, integrity-verified, provenance per path
