    ...
    func german() {
        #expect(
            Self.sample(DecoyLocaleDE.locale) == [
                ...
                "Tunesien",
                "Kahlmeyer-Gotz",
                "luka.ihly@example.net",
                "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_15_7) AppleWebKit/601.51.18 (KHTML, like Gecko) Chrome/129.1.10.7 Safari/580.75.72",
                "Bespoke Rubber Keyboard",
                "GB54YXOW09174811822294",
                "5560-2520-6625-3715",
                "Schraube",
    ...
    func japanese() {
        #expect(
            Self.sample(DecoyLocaleJA.locale) == [
                ...
                "マヨット",
                "吉井, 川村 and 藤岡",
                "user437.user947@example.net",
                "Googlebot/2.1 (+http://www.google.com/bot.html)",
                "Ergonomic Granite Cheese",
                "GB09QTSM07599580917481",
                "4222-9416-8602-5205",
                "火付け",
                "日没 基盤 汚す よくあつ 九日 着く 親切 妻.",
                "白",
                "CH0ZFMSECJ1UUZWGZ",
                "word265-word984.shf",
                "0xe15a7c02c3df7b42682b218815396c08aa5e4979",
                "019b76da-a800-78fe-9cbb-ae72a0d74d2c",
            ]
        )
    }
