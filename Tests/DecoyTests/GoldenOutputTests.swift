    ...
    func german() {
        #expect(
            Self.sample(DecoyLocaleDE.locale) == [
                ...
                "Tunesien",
                "Gumbel-Dorfmann",
                "volker.kunde@example.net",
                "Mozilla/5.0 (Linux; Android 15; SM-G991B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/191.0.0.0 Mobile Safari/537.36",
                "Fantastic Metal Sausages",
                "GB06SMBT59958091748118",
                "2346-9416-8602-5200",
                "quartette",
