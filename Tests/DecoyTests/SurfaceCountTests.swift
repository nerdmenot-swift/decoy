...
struct SurfaceCountTests {
    ...
    func generatorCount() throws {
        ...
        // 18 namespaces and 196 methods. `DateFaker` is compiled only where Foundation
        // is, so a build without it has 17 and 178 — both figures are in the README and
        ...
        #expect(
            total == 196,
            """
            generator methods: expected 196, found \(total).
        ...
        #expect(withoutDate == 178, "without Foundation: expected 178, found \(withoutDate)")
    }
